<nav class="navbar navbar-expand-lg custom-navbar-up">
    <div class="container-fluid">
        ...
        <div class="d-grid gap-2 d-md-block justify-content-end">
            <div class="btn-sm">
                <a class="btn btn-dark" href="/">Dark Mode</a>
                <div class="btn-group btn-sm">
                    <a class="btn btn-success" href="/login">Login</a>
                    <a class="btn btn-primary" href="/register">Register <i class="bi bi-box-arrow-in-right"></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ $title === 'HTML' ? 'active' : '' }}" href="#">HTML</a>
                </li>
                <li class="nav-item">
